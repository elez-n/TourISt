...
namespace API.Data.Migrations
{
    ...
    [Migration("20260305105421_RegistrationRequest2")]
    partial class RegistrationRequest2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvaluationScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Evaluation", b =>
                {
                    ...
                    b.HasOne("API.Entities.User", "Officer")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
